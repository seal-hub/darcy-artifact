...
public class CardDrawnCommand extends Command {

	public final boolean handcard;
	public final int seat;
	public final List<Card> cards;

	public CardDrawnCommand(List<Card> cards, boolean handCard, int seat) {
		super("同步動畫", "卡牌抽取");
	...
	public CardDrawnCommand(Card card, boolean handCard, int seat) {
